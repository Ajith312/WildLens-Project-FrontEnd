    ...
    <div className="homepage-navbar">
      <div className="navbar-discout-container bg-dark p-2 d-flex">
        ...
        <div className="col-12 col-lg-5 d-flex align-items-center justify-content-center ">
          <p className="fs-5 ms-2 text-white text-wrap">
      ...
      <div className="navbar-menu-container bg-success-subtle p-2 d-flex justify-content-between ">
        ...
        <div className="col-lg-7 d-none d-xl-flex flex-column justify-content-center">
                ...
                <ul className="nav-menu-content d-flex justify-content-evenly mb-0">
                    <li className="navMenuItem"><NavLink to='/home'>HOME</NavLink></li>
                    <li className="navMenuItem"><NavLink to='/about'>ABOUT</NavLink></li>
                    <li className="navMenuItem" ><NavLink to='/tour'>TOUR PACKAGES</NavLink></li>
                    <li className="navMenuItem"><NavLink to='/gallery'>GALLERY</NavLink></li>
                    <li className="navMenuItem"><NavLink to='/contact'>CONTACT</NavLink></li>
          </ul>
     
        </div>
        <div className="col-3 col-sm-3 col-lg-3 nav-menu-profile d-flex align-items-center justify-content-evenly">
          <button className="btn btn-warning px-4 d-none d-xl-block">PROFILE</button>
          <button className="btn btn-warning px-4 d-none d-xl-block">LOGOUT</button>
